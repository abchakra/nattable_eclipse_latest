...
public class SamplePart {
	...
	public void createComposite(Composite parent) {
		...
		NatTable natTable = (NatTable) createExampleControl(parent);
	...
	public Control createExampleControl(Composite parent) {
		...
		String[] propertyNames = { "firstName", "lastName", "gender", "married", "birthday", "address.street",
		...
		IColumnPropertyAccessor<PersonWithAddress> columnPropertyAccessor = new ExtendedReflectiveColumnPropertyAccessor<>(
				propertyNames);

		BodyLayerStack<PersonWithAddress> bodyLayerStack = new BodyLayerStack<>(PersonService.getPersonsWithAddress(50),
		...
		FilterRowHeaderComposite<PersonWithAddress> filterRowHeaderLayer = new FilterRowHeaderComposite<>(
